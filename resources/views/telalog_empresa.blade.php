...
<header class="bg-neutral-100 shadow-lg  mb-7">
  ...
  <div id="mobile-menu" class="lg:hidden" role="dialog" aria-modal="true">
    ...
    <div class="min-h-screen flex flex-col justify-center bg-blue-400">
        <div class="bg-white mx-auto max-w-md py-8 px-10 shadow rounded-lg">
            ...
            <form action="">
                <div class="mb-4">
                    <input type="text" placeholder="CNPJ" class="appearance-none block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-50 focus:bg-white border border-gray-200 focus:border-gray-500 rounded focus:outline-none">
                </div>
                <div class="mb-4">
